...
<HTML>
	...
	<body>
		<s:form action="editUser" name="Form1" enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<s:textfield name="loginName" value="%{loginName}" cssClass="bg"/>
					</td>
				</tr>
				<tr>
					<td align="center" bgColor="#f5fafe" class="ta_01"> 密码：</td>
					<td class="ta_01" bgColor="#ffffff">
						<s:password name="loginPwd" value="%{loginPwd}" showPassword="true"/>
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">用户姓名：</td>
					<td class="ta_01" bgColor="#ffffff">
						<s:textfield name="userName" value="%{userName}" cssClass="bg"/>
					</td>
				</tr>
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:select list="{'研究生','本科','专科','高中','初中','小学'}" value="%{education}" name="education" headerKey="" headerValue="--选择学历--"></s:select>
					</td>
				</tr>
				<tr>
					<td align="center" bgColor="#f5fafe" class="ta_01">出生日期：</td>
					<td class="ta_01" bgColor="#ffffff">
						<s:textfield name="birthday" value="%{birthday}" cssClass="bg" readonly="readonly" id="birthday" size="20"/>
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">电话：</td>
					<td class="ta_01" bgColor="#ffffff">
						<s:textfield  name="telephone" cssClass="bg" id="telephone" value="%{telephone}"/>
					</td>
				</tr>
				<tr>
					<td align="center" bgColor="#f5fafe" class="ta_01">兴趣爱好：</td>
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						<s:checkboxlist list="{'看电影','旅游','健身','购物','睡觉'}" value="hobby.split(', ')" name="hobby"></s:checkboxlist>
					</td>
				</tr>
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						...
						<s:else>
							<div id="uploadDiv" style="display:none">
								<s:file name="upload" size="30"></s:file>
								<input type="button" id="uploadbtn" value="取消上传"/>
							</div>
							<div id="showDiv" style="display:block">
								<s:url action="download" namespace="/user" var="url_download">
								...
								<input type="button" id="showbtn" value="重新上传"/>
							</div>
						</s:else>
					</td>
				</tr>
				<TR>
					...
					<TD class="ta_01" bgColor="#ffffff" colSpan="3">
						<s:textarea name="remark" cols="30" rows="3" cssStyle="WIDTH: 96%" value="%{remark}"></s:textarea>
					</TD>
				</TR>
				<TR>
