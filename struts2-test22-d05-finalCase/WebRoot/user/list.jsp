...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			function addUser(){
				/* 跳转到动作类只是为了经过一下服务器 */
				window.location.href = "${pageContext.request.contextPath}/addUIUser.action";
			}
			function delUser(userid){
				if(window.confirm("确定删除吗?")){
					window.location.href="${pageContext.request.contextPath}/deleteUser.action?userID="+userid;
				}
			}
		</script>
	</HEAD>
	<body>
		<br>
		<s:form action="findUserByCondition">
				...
				<TBODY>
					...
					<tr>
						<td>
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
									<td height="22" align="center" bgColor="#f5fafe" class="ta_01">用户姓名</td>
									<td class="ta_01" bgColor="#ffffff">
										<s:textfield name="userName" size="15" cssClass="bg"/>
									</td>
									<td height="22" align="center" bgColor="#f5fafe" class="ta_01">性别：</td>
									<td class="ta_01" bgColor="#ffffff">
										<s:select list="{'男','女'}" name="gender" headerKey="" headerValue="--选择性别--"></s:select>
									</td>
								</tr>
								<tr>
									<td height="22" align="center" bgColor="#f5fafe" class="ta_01">学历：</td>
									<td class="ta_01" bgColor="#ffffff">
										<s:select list="{'研究生','本科','专科','高中','初中','小学'}" name="education" headerKey="" headerValue="--选择学历--"></s:select>
									</td>
									<td height="22" align="center" bgColor="#f5fafe" class="ta_01">是否上传简历</td>
									<td class="ta_01" bgColor="#ffffff">
										<s:select list="#{'true':'有','false':'无'}" headerKey="" headerValue="--请选择--" name="isUpload"></s:select>
									</td>
								</tr>
								<tr>
					...
					<tr>
						<td class="ta_01" align="right">
							<button type="button" id="add" name="add" value="添加用户" class="button_add" onclick="addUser()">添加用户</button>
						</td>
					</tr>
					<tr>
							...
							<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1" style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid; WIDTH: 100%; WORD-BREAK: break-all; BORDER-BOTTOM: gray 1px solid; BORDER-COLLAPSE: collapse; BACKGROUND-COLOR: #f5fafe; WORD-WRAP: break-word">
								...
								<s:iterator value="users">
									<tr onmouseover="this.style.backgroundColor = 'white'"onmouseout="this.style.backgroundColor = '#F5FAFE';">
										<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="18%">${loginName}</td>
										<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="17%">${userName }</td>
										<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="8%">${gender}</td>
										<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="23%">${telephone }</td>
										<td style="CURSOR: hand; HEIGHT: 22px" align="center">${education }</td>
										<td align="center" style="HEIGHT: 22px">
											<!-- 编辑 -->
											<s:a action="editUIUser">
												<!-- 传入当前要查看的用户id -->
										...
										<td align="center" style="HEIGHT: 22px">
											<!-- 删除 -->
											<a href="javascript:delUser(${userID})">
